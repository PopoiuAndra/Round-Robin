...
public class GanttChartGUI extends JFrame implements SimulationEventListener {
    ...
    // NOU: Înregistrăm execuția pe Hard Disk
    @Override
    ...
    private class GanttPanel extends JPanel {
        ...
        public Dimension getPreferredSize() {
            ...
            // Am adăugat +1 la size pentru rândul de DISK
        ...
        // Metodă ajutătoare pentru a nu repeta codul la desenarea blocurilor CPU
